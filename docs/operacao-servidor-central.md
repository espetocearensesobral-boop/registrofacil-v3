...
| Etapa | Procedimento |
|---|---|
| Build | Executar `BUILD_WINDOWS.bat` em uma máquina Windows com Python 3.12 ou 3.11. O script prioriza o Python Launcher 3.12, aceita 3.11 como fallback, procura interpretadores no `PATH` e instalações padrão do Python.org, valida a versão e cria `.venv-build` antes de gerar `dist\RegistroFacil`. |
