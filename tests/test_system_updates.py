...
def test_fetch_manifest_rejects_insecure_package_url(monkeypatch):
    payload = {"version": "3.23.0", "package_url": "http://insecure/app.zip", "sha256": "a" * 64}
