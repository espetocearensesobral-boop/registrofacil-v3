        ...
        function render(data) {
            ...
            results.innerHTML = data.processos.map(item => `
                <article class="rf-process-report-row">
                    ...
                    <div class="rf-process-report-actions" aria-label="Ações do processo"><a class="nav-btn nav-btn-secondary rf-search-action rf-search-action-view" href="${item.visualizar_url}" aria-label="Visualizar processo" title="Visualizar processo"><i class="bi bi-eye" aria-hidden="true"></i></a><a class="nav-btn nav-btn-secondary rf-search-action rf-search-action-print" target="_blank" rel="noopener" href="${item.imprimir_url}" aria-label="Imprimir processo" title="Imprimir processo"><i class="bi bi-printer" aria-hidden="true"></i></a><a class="nav-btn nav-btn-primary rf-search-action rf-search-action-download" href="${item.baixar_url}" aria-label="Baixar PDF do processo" title="Baixar PDF"><i class="bi bi-file-earmark-pdf" aria-hidden="true"></i></a></div>
                </article>`).join('');
