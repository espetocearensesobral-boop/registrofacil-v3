...
with tempfile.TemporaryDirectory() as temp_dir:
    ...
    assert status_id
    linked_process_id = models.executar_query(
        "INSERT INTO processos (numero_processo, titular, titular_id, tipo_id, status_id, apresentante, apresentante_id, matricula) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        ["PROC-APP-SMOKE", "Titular Smoke", titular_id, service_id, status_id, "Apresentante Smoke", apresentante_id, "MAT-APP-SMOKE"],
    )
